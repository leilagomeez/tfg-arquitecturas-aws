...
--
-- Host: supplierdb.cluster-cfm2osq2svrh.us-east-1.rds.amazonaws.com    Database: COFFEE
-- ------------------------------------------------------
...
CREATE TABLE `beans` (
  ...
  `product_name` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `price` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `suppliers` (
  ...
  `city` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `state` varchar(255) COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
-- Dump completed on 2026-05-04 17:34:54
